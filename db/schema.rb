...
ActiveRecord::Schema.define(version: 20161117160338) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["project_document_id"], name: "index_comments_on_project_document_id", using: :btree
  ...
  add_foreign_key "comments", "project_documents"
